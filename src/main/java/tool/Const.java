...
public class Const {
	...
	// 画面URL
	public static final String URL_START = "start.jsp";
	public static final String URL_CONSUMER = "consumer.jsp";
	public static final String URL_ADMIN = "admin.jsp";

	// エラーメッセージ
	public static final String MSG_SOLD_OUT = "売り切れ";
	...
	public static final String REGEX_BLANK_FIRST = "^[\\s ]+";
	public static final String REGEX_BLANK_END = "[\\s ]+$";
